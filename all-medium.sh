...
FIRST_LAST_SELF_HOSTED="$(normalize_space_id "${5:-${WAN22_FIRST_LAST_SELF_HOSTED_SPACE:-${WAN22_FIRST_LAST_SELF_HOSTED_URL:-https://huggingface.co/spaces/eggman-poff/wan-mixed}}}")"
SINGLE_SELF_HOSTED="$(normalize_space_id "${6:-${WAN22_SINGLE_SELF_HOSTED_SPACE:-${WAN22_SINGLE_SELF_HOSTED_URL:-https://huggingface.co/spaces/eggman-poff/wan-mixed}}}")"
