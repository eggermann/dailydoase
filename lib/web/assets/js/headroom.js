...
// select your header or whatever element you wish
        ...
        headroom2.init();
        // Add Headroom to nav.headroom
        const asideMenu = document.querySelector('nav.headroom');
        if (asideMenu) {
            const headroomAside = new Headroom(asideMenu, {
                ...options,
                onUnpin: () => {} // Prevent unpinning for aside menu
            });
            headroomAside.init();
        }
    }
