...
const { isBlackImage } = require(path.join(__dirname, 'lib/utils/is-black-image.js'));
        ...
        try {
            ...
            const payload = {
                ...
                parameters: {
                    ...
                    // negative_prompt: options.negative_prompt || 'katze',fail
                    //    temperature:.7fail
                    //ok  num_inference_steps: 10
                },
            };
            ...
            store.addFile(imageFolderDir, imageName)
            // Save metadata
            const metadata = {
                prompt,
                totalPrompt,
