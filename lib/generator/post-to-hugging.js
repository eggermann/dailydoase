...
*
const CONFIG = {
    pollingTime: 4000, // Polling interval in milliseconds
    description: 'flux schnell',
    folderName: 'HF',
    huggingFaceModelUrl: 'https://api-inference.huggingface.co/models/black-forest-labs/FLUX.1-schnell',
...
class HuggingFace extends PostTo {
    constructor(modelConfig) {
        ...
        // this.pollingTime = pollingTime ?? 4000;
    }
