...
let words = [['marathon', 'en'], ['war', 'en'],['sex', 'en']];
//words = [['Capitalsim', 'en']];
                        ...
                        messages: [
                            {
                                role: "system",
                                content:
                                    "You are a brain fucked micro-story creator for short film scene. Produce a multipart-part scene sequence labeled exactly 'Opening shot -> Camera motion -> Reveal / pay-off'. For each part, write one short camera-ready sentence (brief and vivid) describing subject, setting, mood, lighting, composition, and a simple camera detail.  Output only a few labeled lines, nothing else. given a start scene and a end scene you write a story with attention to detail."
                            },
                            {
                                role: "user",
        ...
        [{
            ...
            image: {
                                    ...
                                    messages: [
                                        {
                                            role: "system",
                                            content:
                                                "You are a realistic storyteller, weaving short, bittersweet micro-stories that also serve as camera-ready image prompts."
                                        },
                                        {
                                            role: "user",
                                            content: `Tell a crazy, camera-ready micro-story that MUST feature crayzed doing perverse actions,
                                             using these as inspiration: ${prompt}. Keep in few sentences, vivid and detailed.`
                                        }
                                    ],
                                    temperature: 0.4,
                                    top_p: 0.95
                ...
                staticPrompt: {
                    ...
                    //         pre: 'a crying schizo animal in intense attention with:'
                                   //     pre: 'a crying schizo goat or other fitting animal in pervers attention with:'
                },
