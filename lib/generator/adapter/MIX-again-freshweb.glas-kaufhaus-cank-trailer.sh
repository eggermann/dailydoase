...
# CANK GOOD-3 trailer launcher.
# One vertical GOOD-3 trailer iteration per cycle, then wait 24 hours.
...
export FRESHWEB_FOLDER=${FRESHWEB_FOLDER:-glas-kaufhaus-cank-trailer-good-3-live}
export GENERATIONS_PATH=${GENERATIONS_PATH:-$REPO_ROOT/GENERATIONS-CANK-TRAILER-GOOD-3}
...
export FRESHWEB_WORDS="${FRESHWEB_WORDS:-Department store,en | Landscape,en | Art exhibition,en | Animals,en}"
