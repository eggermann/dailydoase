...
const imageModelData = {
  ...
  num_inference_steps: Number(process.env.FRESHWEB_MIDDLE_IMAGE_STEPS) || 6,
  guidance_scale: Number(process.env.FRESHWEB_MIDDLE_IMAGE_GUIDANCE) || 2.2,
...
const video2 = {
  ...
  model: {
    ...
    sampling_steps: Number(process.env.FRESHWEB_MIDDLE_VIDEO_SAMPLING_STEPS) || 16,
...
const resolveOpeningCameraShot = async () => {
  ...
  return getIamge({
    ...
    width: Number(process.env.FRESHWEB_MIDDLE_4_3_CAMERA_WIDTH) || Number(process.env.FRESHWEB_MIDDLE_CAMERA_WIDTH) || 1024,
    height: Number(process.env.FRESHWEB_MIDDLE_4_3_CAMERA_HEIGHT) || Number(process.env.FRESHWEB_MIDDLE_CAMERA_HEIGHT) || 768,
