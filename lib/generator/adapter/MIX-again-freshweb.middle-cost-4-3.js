...
const CONFIG = {
  story: {
    ...
    visualDirection: 'documentary, realistic, visually distinct scenes, coherent camera-led progression, better image quality',
    ...
    controlsVideoMode: true,
    firstClipVideoMode: 'singleImage',
    laterSingleImageDefault: false,
