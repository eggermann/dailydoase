...
describe('Generator.resolveChainedStartFrameFromLastEnd', () => {
  ...
  test('caps a multi-image drift request at ten total images and prioritizes the fresh person', async () => {
    const tempDir = await createTempDir();
    ...
    const expectedSecondaryRefs = [screenshotPaths[8], screenshotPaths[7], ...expectedBuffer]
