...
export FRESHWEB_SCENE_LENGTH_MULTIPLIER="${FRESHWEB_SCENE_LENGTH_MULTIPLIER:-1.4}"
...
# Keep the cap knob visible in this preset, but leave it disabled by default.
export FRESHWEB_SINGLE_FPS="${FRESHWEB_SINGLE_FPS:-16}"
export FRESHWEB_SINGLE_VIDEO_MAX_DURATION="${FRESHWEB_SINGLE_VIDEO_MAX_DURATION:-}"
