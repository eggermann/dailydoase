...
test('buildCameraGroundedPrompt adds anti-freeze guidance for short camera single-image shots', () => {
  ...
  expect(prompt).toContain('Fit the action to a 1.2-second held shot: play one immediate readable beat with visible subject movement and one clear camera accent, and avoid a frozen portrait hold.');
});
