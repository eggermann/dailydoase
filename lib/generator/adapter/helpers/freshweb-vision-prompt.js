...
export const PHOTOGRAPHIC_REALITY_LOCK_SENTENCE = 'Reality lock: one coherent photoreal camera world; no cartoon, icon, illustration, CGI, or mixed rendering styles.';

export const appendPhotographicRealityLock = (prompt = '') => [
  String(prompt || '').trim(),
