...
export const buildCameraGroundedPrompt = ({
  ...
  const productionDirection = preserveBasePrompt
    ? compactScenePrompt(normalizeVisionText(basePrompt), 3, 72)
    : '';
  ...
  const actorCountLockSentence = lockActorCount
    ? buildActorCountLockSentence({
