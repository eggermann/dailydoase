...
export const DEFAULT_SCENE_SYSTEM_PROMPT = [
  ...
  'For every scene, write storyCause, monsterIntent, and roomConsequence. storyCause says how the current semantic collision changes the story; monsterIntent says what the monster now wants or decides to do; roomConsequence says the visible aftermath that the next scene inherits.',
  'Those three fields must describe an inferred story, not define literal props, labels, or a glossary for individual words.',
