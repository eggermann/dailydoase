...
export const DEFAULT_SCENE_SYSTEM_PROMPT = [
  ...
  'When configMode is "camera", treat the vision story context as the hard visible inventory for the scene plan.',
  'When configMode is "camera", do not introduce objects, furniture, appliances, tools, food items, or room expansions that are not explicitly visible in the vision story context.',
        ...
        },
        {
          ...
          content: [
            ...
            `Camera-mode visible-anchor rule: ${
              normalizeString(configMode, 'generated') === 'camera'
                ? 'only use people, props, furniture, appliances, and room elements that are explicitly visible in the vision story context. If the context does not name a pan, bottle, stove, plate, or table, do not mention one in stillPrompt, imageDescription, motionCue, cameraCue, videoPrompt, or singleImagePrompt.'
                : 'n/a'
            }`,
