    ...
    async prompt(streams, options = {}) {
        ...
        try {
            ...
            if (videoPrompt.create) {
                console.log('videoPrompt.create exists', startFrame.json.metadata.prompt, this.lastEndFRame.json.metadata.prompt);
                prompt = videoPrompt.create(startFrame.json.metadata.prompt, this.lastEndFRame.json.metadata.prompt);
