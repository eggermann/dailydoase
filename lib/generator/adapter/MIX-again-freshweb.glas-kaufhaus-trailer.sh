...
# Preserve a proven protagonist while the camera waits for a genuinely new one.
export FRESHWEB_CAMERA_MAX_LAST_VALID_REUSES=${FRESHWEB_CAMERA_MAX_LAST_VALID_REUSES:-20}
