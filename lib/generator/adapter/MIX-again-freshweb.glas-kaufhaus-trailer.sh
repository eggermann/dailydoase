...
export FRESHWEB_START_FRAME_STRATEGY_GUIDANCE="${FRESHWEB_START_FRAME_STRATEGY_GUIDANCE:-Choose from story need: continuity, identity repair, or spatial reorientation.}"
