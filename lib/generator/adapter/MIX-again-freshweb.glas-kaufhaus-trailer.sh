...
# Keep the history small and cap the whole request as well: last film frame,
# current visitor, room anchor, and at most one recent supporting camera shot.
export FRESHWEB_DRIFT_CONTEXT_BUFFER_SIZE=${FRESHWEB_DRIFT_CONTEXT_BUFFER_SIZE:-2}
export FRESHWEB_DRIFT_CONTEXT_MAX_REFERENCE_IMAGES=${FRESHWEB_DRIFT_CONTEXT_MAX_REFERENCE_IMAGES:-4}
