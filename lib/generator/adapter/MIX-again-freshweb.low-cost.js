...
const VISION_PROVIDERS = (process.env.FRESHWEB_TEST_VISION_PROVIDERS || '')
  .split(',')
...
const buildVisionAwarePrompt = ({
  ...
  const startAnchor = normalizeVisionText(startVision);
  const endAnchor = normalizeVisionText(endVision);
