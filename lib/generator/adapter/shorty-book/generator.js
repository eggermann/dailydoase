...
class Generator extends PostTo {
  ...
  buildSceneContextFluxPrompt({
    ...
    return [
      ...
      'Preserve the photographed Kaufhaus architecture, camera viewpoint, exposure, color balance, floor, ceiling, ducts, windows, columns, walls, elevators, and empty spatial layout as the dominant composition. Do not replace or globally restyle this exact location.',
      referenceRule,
      protagonistRule,
      personaReferenceIdentityClause,
