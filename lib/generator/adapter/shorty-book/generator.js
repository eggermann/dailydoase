...
import {
  appendPhotographicRealityLock,
  buildCameraGroundedPrompt,
  PHOTOGRAPHIC_REALITY_LOCK_SENTENCE,
...
class Generator extends PostTo {
  ...
  buildSceneContextFluxPrompt({ scenePlanEntry = {}, sceneContext = {}, contextImage = null } = {}) {
    ...
    return appendPhotographicRealityLock([
  ...
  async continueSceneLoop({
    ...
    for (let index = startIndex; index < clipCount; index += 1) {
      ...
      const shouldGenerateCastContextFrame = !plannedSingleImageContinuation
