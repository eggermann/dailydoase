...
class Generator extends PostTo {
  ...
  async correctLastFrameForNextScene({ lastFrame, nextScenePlanEntry, nextSceneContext }) {
    ...
    // Runware treats reference image 1 as its strongest continuity anchor.
    // Keep the live camera/person reference directly after the current last
    // frame, then retain the canonical opening and historical context.
