...
const storedScenePlan = Array.isArray(snapshot.runtimeScenePlan)
...
if (storedScenePlan.length < 2) {
  throw new Error(`Two-video preview needs at least two saved scenes: ${snapshotPath}`);
}
