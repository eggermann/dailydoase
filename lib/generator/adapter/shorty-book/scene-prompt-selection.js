...
export const PHOTOGRAPHIC_REALISM_LOCK = [
  'LIVE-ACTION PHOTOGRAPHY ONLY. Make a dark cinematic thriller frame on a real Kaufhaus film set; this rule overrides every conflicting style phrase.',
  'Use a grounded practical-effects aesthetic: creatures, people and props are full-scale and physically present, with weight and contact shadows.',
  'Use physically accurate imperfect materials: scratched metal, dusty glass, fingerprints, worn plastic, dirty tile, organic pores and folds.',
  'Use low-key motivated practical lighting, slight underexposure, deep natural shadows, realistic bounce and subtle haze.',
  'Use ARRI Alexa 35 live-action tonal response, 35mm anamorphic optics, soft highlight roll-off and fine analog film grain.',
  'Keep humans natural, ordinarily dressed and candid.',
  'No illustration, comic, anime, cel shading, 3D cartoon, glossy CGI, concept art, toy-like plastic, smooth artificial textures or excessive sharpness; 8K, Octane and Unreal terms cannot override live action.',
].join(' ');
