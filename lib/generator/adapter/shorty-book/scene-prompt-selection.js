...
export const PHOTOGRAPHIC_REALISM_LOCK = [
  'Photographic realism is mandatory: output one real, unretouched documentary photograph made inside an existing building.',
  'Use physically plausible optics, modest dynamic range, imperfect exposure, natural sensor noise, irregular surface microtexture, believable contact shadows and practical light.',
  'Express semantic concepts as real materials and physical events, never as illustration, cartoon, animation, game art, concept art, toy-like CGI or a polished 3D render.',
].join(' ');
