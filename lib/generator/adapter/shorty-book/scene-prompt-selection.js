...
export const PHOTOGRAPHIC_REALISM_LOCK = [
  'LIVE-ACTION PHOTOGRAPHY ONLY. Output one real, unretouched dark cinematic documentary frame made on a physical Kaufhaus film set; photographic realism overrides every conflicting style phrase in the scene description.',
  'Use a grounded practical-effects aesthetic: creatures, people, props and semantic events must feel physically present, full-scale and integrated through weight, contact shadows, residue and believable interaction with the room.',
  'Use physically accurate imperfect materials: brushed and scratched metal, dusty glass, fingerprints, worn plastic, dirty matte concrete or tile, small debris, irregular organic pores, scars, folds, subtle translucency and natural surface microtexture.',
  'Use low-key motivated practical lighting, slightly underexposed exposure, deep natural shadows, strong but plausible contrast, realistic indirect bounce, subtle haze, restrained reflections and soft highlight roll-off.',
  'Use ARRI Alexa 35 live-action tonal response, 35mm anamorphic cinema optics, natural lens distortion, restrained shallow depth of field, subtle chromatic aberration, realistic motion blur where movement exists and fine analog film grain.',
  'People must have natural proportions, realistic skin, ordinary clothing and candid unposed body language.',
  'Never render illustration, comic-book art, anime, cel shading, 3D cartoon, glossy CGI, plastic surfaces, clean vector-like edges, oversaturated colors, fantasy concept art, toy-like objects, smooth artificial textures or excessive digital sharpness.',
  'Terms such as beautiful, fantasy, highly detailed digital art, 8K render, Octane, Unreal Engine or concept art may describe content only and must never change the mandatory live-action practical-effects rendering.',
].join(' ');

export const CANONICAL_MONSTER_REALISM_LOCK = [
  'The only allowed monster identity is the exact supplied green botanical protagonist: elongated bark face, amber eyes, leaf ears, mouth tendril and rooted botanical anatomy.',
  'Keep it visibly green, weathered and materially plausible as a full-scale practical sculpture physically photographed in the Kaufhaus; never redesign it as another species or generic creature.',
].join(' ');
