...
export const PHOTOGRAPHIC_REALISM_LOCK = [
  'LIVE-ACTION PHOTOGRAPHY ONLY. Make a candid 1983 dark-fantasy production still on a physical Kaufhaus set; this rule overrides every conflicting style phrase.',
  'Photograph real full-scale practical effects with weight, imperfect contact shadows and believable interaction with the set.',
  'Use physically accurate worn materials: scratched metal, dusty glass, fingerprints, dirty tile, chipped paint, ordinary clutter and smudges.',
  'Use one harsh dim overhead fluorescent practical, slight underexposure, soft natural shadows, dust motes and imperfect exposure.',
  'Shot on an Arriflex 35 III with a 35mm prime at f/2.8 on Kodachrome 64: faded 1980s color, heavy irregular 35mm grain, dust specks, subtle chromatic aberration, lifted blacks, slight softness and restrained motion blur.',
  'Keep humans natural, ordinarily dressed, candid and slightly imperfect.',
  'No illustration, comic, anime, cel shading, digital art, glossy CGI, modern digital sharpness, concept art, toy-like plastic, smooth geometry, perfect clean edges, 4K, 8K, Octane or Unreal Engine.',
].join(' ');
...
export const CANONICAL_MONSTER_REALISM_LOCK = [
  ...
  'Realize that exact identity as a full-scale 1983 foam-latex and silicone animatronic practical effect with glass eyes, visible pores, uneven hand-painted acrylic detail, subtle mold texture and restrained wet resin only where moisture belongs.',
  'Keep it visibly green, weathered, handmade and physically photographed in the Kaufhaus; never redesign it as another species or generic creature, and never make it a smooth digital humanoid.',
].join(' ');
