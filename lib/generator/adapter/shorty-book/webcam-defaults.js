...
export const DEFAULT_WEBCAM_CAMERA_SCENE_SYSTEM_PROMPT = [
  DEFAULT_SCENE_SYSTEM_PROMPT,
  'REFERENCE IMAGE: Detected people and room are visual source material. Identity, position, geometry, typography, objects, and transformations may drift when the story or surreal mode benefits.',
  'EXISTING-ROOM-FIRST: Visible people, objects, artwork, openings, light, and geometry are stage and props. Make a detected feature carry each action.',
  'Semantic cues alter existing people, room, or their relationship.',
  'New surreal elements should grow visibly from an existing form, object, light, or action so camera origin stays readable.',
  'Reflections remain attached to their surface, never independent duplicates.',
  'Ordered cues cause visible consequences through people, room, objects, atmosphere, typography, or transformation. Carry residue forward.',
