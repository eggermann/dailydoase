...
const CAMERA_LANGUAGE_PATTERN = /\b(?:camera|framing|crop|push|drift|reframe|zoom|tilt|pan|focus|hold|tighten|widen)\b/i;
...
const fragmentSupportsMotion = (fragment, actorVisible = true) => {
  ...
  return fragment.kind === 'motion' || fieldContainsActorLanguage(fragment.text);
};
