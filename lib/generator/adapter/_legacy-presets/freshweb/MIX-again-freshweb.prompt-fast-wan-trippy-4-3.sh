...
# Respect an explicitly empty fallback list from the caller.
...
export FRESHWEB_IMAGE_WIDTH=448
export FRESHWEB_IMAGE_HEIGHT=336
export FRESHWEB_VIDEO_WIDTH=448
export FRESHWEB_VIDEO_HEIGHT=336
export FRESHWEB_SINGLE_VIDEO_WIDTH=448
export FRESHWEB_SINGLE_VIDEO_HEIGHT=336
export FRESHWEB_VIDEO_CUSTOM_MAX_AREA=150528
export FRESHWEB_WAN_FORCE_REQUESTED_DIMENSIONS=1
