...
const main = async () => {
  ...
  const visualDirection = [
    ...
    'Treat the supplied Kaufhaus photos as the fixed physical world for every scene. Preserve their architecture, mirrored columns, open technical ceiling, fluorescent fixtures, concrete floor, elevators, windows, and white partition walls. Do not introduce people.',
  ...
  const scenePlanSystemPrompt = [
    ...
    'Location dossier: real empty Kaufhaus interior with raw concrete floor, exposed ducts and cables, suspended fluorescent fixtures, mirrored structural columns, elevators, windows, brick walls, and white exhibition partitions. Every scene happens inside this same photographed location. Do not introduce people.',
