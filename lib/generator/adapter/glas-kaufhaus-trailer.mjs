...
const main = async () => {
  ...
  const visualDirection = [
    ...
    creativeRule,
    'Compose every scene as a semantic collision: keep one stable anchor and let the incompatible collision terms visibly infect bodies, objects, light, behavior, or architecture. Never explain or harmonize the contradiction.',
  ...
  const scenePlanSystemPrompt = [
    ...
    'Each source cue labels one stable Anchor plus incompatible Collision terms. Keep these roles distinct. Do not reconcile, explain, or summarize the contradiction; turn it into visible physical action.',
    ...
    'People may appear when the semantic streams naturally call for them; neither add nor exclude them by default.',
    'The ordered words 1983, Kaufhaus, Kunstausstellung must repeatedly and differently alter the protagonist, room, gesture, sound-implied rhythm, atmosphere, light, composition, or camera emphasis across the requested scenes.',
