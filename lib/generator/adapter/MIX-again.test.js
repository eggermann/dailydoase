...
const USE_SINGLE_IMAGE = process.env.USE_SINGLE_IMAGE;
...
const useSingleImage = (() => {
  if (USE_SINGLE_IMAGE === '1') return () => true;
  if (USE_SINGLE_IMAGE === '0') return () => false;
  return () => false;
})();

const words = [/*['SS', 'en'],*/ ['fashion', 'en']/*, ['Patriarch', 'en']*/];
