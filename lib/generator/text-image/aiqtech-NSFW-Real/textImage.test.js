...
test('returns a created image file path (real API)', async () => {
  ...
  const res = await api.prompt('futuristic android hero striking an action pose, high detail, photorealistic');
...
// npm test -- lib/generator/text-image/aiqtech-NSFW-Real/textImage.test.js
