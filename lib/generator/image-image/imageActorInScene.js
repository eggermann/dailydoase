...
export class PostToHF_ImageActorInScene extends PostTo {
  constructor(modelConfig = {}) {
    ...
    this.hfProvider = this.config.hfProvider || process.env.HF_PROVIDER || 'hf-inference';
  ...
  async prompt(promptText, options = {}) {
    ...
    const hfProvider = options.hfProvider || this.hfProvider || process.env.HF_PROVIDER || null;
