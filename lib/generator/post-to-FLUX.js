    ...
    async prompt(prompt = '', options = {}) {
        ...
        if (this.config.prompts) {
            totalPrompt = await this.config.prompts.create(prompt);
               ...
               console.log('FLUX totalPrompt:', totalPrompt);
console.log('FLUX options   this.config :',   this.config );
            process.exit()
        ...
        //console.log('FLUX prompt:', totalPromptWithStatic, '---> mergedOptions:', mergedOptions);
        //process.exit();
        ...
        if (response.status === 200) {
            ...
            const data = await this.saveFile(buffer, name, totalPromptWithStatic);
            data.json.modelProbe = totalPrompt;//sry TODO renaming and logic of 
            ;
