...
import LTXVideo from './post-to-ltx-distilled-2.js';
...
class GenSeq extends PostTo {
    ...
    async prompt(streams, options = {}) {
        ...
        try {
            ...
            console.log('genSeq prompt:', totalPrompt);
            console.log('genSeq prompt:', data1);



            const ltx = await LTXVideo.get(options.LTXVideo, this.config);
