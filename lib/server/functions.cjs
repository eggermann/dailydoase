...
const LIVE_TRAILER_FOLDERS = ['CANK-TRAILER', 'CANK'];
...
const _ = {
    ...
    createMenu(dir, actFolderName = "/") {
        ...
        const sortedFolders = allFolders.sort((a, b) => {
            const liveTrailerRankA = LIVE_TRAILER_FOLDERS.indexOf(a);
            const liveTrailerRankB = LIVE_TRAILER_FOLDERS.indexOf(b);
