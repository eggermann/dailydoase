            ...
            <div class="playback-controls">
                <label>
                    ...
                    <select id="loop-mode">
                        ...
                        <option value="tail">Newest tail</option>
                    </select>
                </label>
                <label>
                ...
                <label>
                    Tail size
                    <input id="tail-count" type="range" min="2" max="2" step="1" value="2">
                    <output id="tail-count-value">2</output>
                </label>
            </div>
        </section>
        ...
        (() => {
            ...
            const getNextStep = () => {
                ...
                if (!pingPongEnabled || start === end) {
                    return {
                        index: currentIndex >= end ? start : currentIndex + 1,
            ...
            const updateStatus = () => {
                ...
                fileCountEl.textContent = String(playlist.length);
