...
const _ = {
        ...
        let files = fs.readdirSync(p)
            .filter(file => {
                ...
                try {
                    ...
                    const json = fs.readFileSync(mrJSon, {encoding: 'utf8'});
    ...
    getAllFoldersForMEmu(dir, actFolderName = "/") {
        let files = fs.readdirSync(dir).filter(file => {
            ...
            const fileCnt = fs.readdirSync(path.join(dir, folder)).length;
    ...
    roots() {
        ...
        app.get(`/`, (req, res) => {
            ...
            const menu = _.getAllFoldersForMEmu('./../images');
        ...
        app.get(`/v/:version/`, (req, res) => {
            ...
            const menu = _.getAllFoldersForMEmu('./../images', actFolderName);
