...
const RESULT_FILE = __dirname + 'chat_model_probe_results.json';
...
function chatWithModel(modelId) {
    ...
    return async (prompt, parameters) => {
        ...
        const res = await fetch(`${CHAT_ENDPOINT}/${modelId}`, {
            method: 'POST',
            headers: HEADERS,
            body,
            timeout: 120000
