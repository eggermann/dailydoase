...
const fileCounter ='XXtest';// new (require('../helper/incremental-call'))('./exemplar-cntr.txt');
const imageDirCounter ='XXtest';//  new (require('../helper/incremental-call'))('./folder-cntr.txt');
