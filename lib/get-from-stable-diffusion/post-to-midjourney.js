...
const _ = {
    ...
    webUi: class extends PostTo {
        ...
        async prompt(prompt, options) {
            let totalPrompt = this.addStaticPrmpt(options);
            const seed = Math.round(120 * Math.random());

            totalPrompt += ` --c 20 --aspect 1:1 --testp   `;// --quality .25 --c 20  --seed ${seed} --testp --aspect 3:2
...
//read in meassag
                    ...
                    const secure = setInterval(grabber, 4000)
